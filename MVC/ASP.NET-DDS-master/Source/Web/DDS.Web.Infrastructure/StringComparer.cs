namespace DDS.Web.Infrastructure
{
    ...
    public static class StringComparer
    {
        ...
        public static double CalculateSimilarity(string source, string target)
        {
            ...
            double percentage = stepsToSame / (double)Math.Max(source.Length, target.Length);
        ...
        /// <param name="source">Source String to Compare with</param>
        /// <param name="target">Targeted String to Compare</param>
        /// <returns>Return the steps needed to transfor the source to the target string.</returns>
