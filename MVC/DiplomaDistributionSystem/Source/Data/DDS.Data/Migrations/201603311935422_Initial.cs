    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Diplomata", t => t.SelectedDiploma_Id)
                .ForeignKey("dbo.Teachers", t => t.Teacher_Id)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Diplomata", t => t.Diploma_Id, cascadeDelete: true)
                .Index(t => t.Tag_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Diplomata", "Teacher_Id", "dbo.Teachers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Students", "SelectedDiploma_Id", "dbo.Diplomata");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.TagDiplomas", "Diploma_Id", "dbo.Diplomata");
            ...
            DropIndex("dbo.Diplomata", new[] { "Teacher_Id" });
            DropIndex("dbo.Diplomata", new[] { "IsDeleted" });
